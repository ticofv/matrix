    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="border-b border-zinc-100 px-6 py-20 bg-zinc-50">
        <div className="max-w-4xl mx-auto">
          <p className="text-amber-500 text-xs tracking-[0.3em] uppercase mb-3">La institución</p>
          <h1 className="text-4xl md:text-5xl font-bold text-zinc-900 mb-4">Acerca del Colegio</h1>
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 space-y-6">
        ...
        <div className="bg-white border border-zinc-100 rounded-sm p-8 shadow-sm">
          <p className="text-amber-500 text-xs tracking-widest uppercase mb-5">Historia</p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-amber-50 border border-amber-100 rounded-sm p-8">
            <p className="text-amber-500 text-xs tracking-widest uppercase mb-5">Misión</p>
          ...
          <div className="bg-white border border-zinc-100 rounded-sm p-8 shadow-sm">
            <p className="text-amber-500 text-xs tracking-widest uppercase mb-5">Visión</p>
            <p className="text-zinc-600 text-sm leading-relaxed">
        ...
        {/* Valores */}
        <div className="bg-white border border-zinc-100 rounded-sm p-8 shadow-sm">
          <p className="text-amber-500 text-xs tracking-widest uppercase mb-6">Valores institucionales</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="text-center p-4 rounded-sm bg-zinc-50">
                <span className="text-3xl block mb-3">{v.icono}</span>
                <p className="text-zinc-900 text-sm font-semibold mb-1">{v.valor}</p>
        ...
        {/* Datos y contacto */}
        <div className="bg-white border border-zinc-100 rounded-sm p-8 shadow-sm">
          <p className="text-amber-500 text-xs tracking-widest uppercase mb-6">Información</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={i} className="flex flex-col gap-1 border-b border-zinc-100 pb-4">
                <span className="text-zinc-400 text-xs uppercase tracking-widest">{item.label}</span>
                <span className="text-zinc-800 text-sm font-medium">{item.valor}</span>
              </div>
            ))}
          </div>
        </div>
